...
export default function CharacterCard({ person, onOpen }) {
  ...
  const colorClass = speciesColor(speciesName, person.name) // 👈 Add name as variation seed

  return (
    <div
      className="rounded-lg shadow-sm overflow-hidden bg-white hover:shadow-md transition cursor-pointer"
